  ...
  >
    <defs>
      <linearGradient :id="this.randomId">
        <stop offset="0%" :stop-color="this.fillColor"></stop>
        <stop :offset="this.offsetValue" :stop-color="this.fillColor"></stop>
        <stop :offset="this.offsetValue" :stop-color="this.baseColor"></stop>
        <stop offset="100%" :stop-color="this.baseColor"></stop>
      </linearGradient>
    </defs>
